...
public class AudioPlayer : MonoBehaviour
{
    ...
    public async Task Play(SpatialAudioEventDataPoint a_audioEventDataPoint)
    {
        var clipsAndRange = await m_audioFileReader.GetAudioClipsAndPlayRange(a_audioEventDataPoint);
