...
{
    public Dictionary<string, Color> ColorMappings { get; set; } = new Dictionary<string, Color>();
    ...
    public abstract void ShowVisualization<T>(Dictionary<string, List<T>> a_pointCollections, LoggingDataPointType a_loggingDataPointType) where T : SpatialLoggingDataPoint;
